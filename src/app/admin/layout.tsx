...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  const navLinks = [
    { href: '/admin/dashboard', icon: Activity, label: 'لوحة القيادة' },
    { href: '/admin/exercises', icon: Dumbbell, label: 'التمارين' },
  ];

  return (
    <div className="bg-neutral-950 text-neutral-100 antialiased min-h-screen flex flex-col selection:bg-amber-500 selection:text-black" dir="rtl">
      
      {/* Floating Sticky Sidebar (Desktop) */}
      <aside className="fixed top-0 right-0 h-screen w-64 m-4 rounded-xl border border-neutral-800 bg-neutral-900/50 backdrop-blur-xl shadow-2xl z-50 hidden lg:flex flex-col justify-between p-4">
        <div>
          {/* Top Brand & Header */}
              ...
              return (
                <Link 
                  ...
                  className={`flex items-center gap-3 px-4 py-3 rounded-lg text-sm font-semibold transition-colors duration-150 ${
                    isActive 
                      ? 'bg-neutral-800 text-amber-500 border-r-4 border-amber-500 shadow-[inset_0_1px_0_rgba(245,158,11,0.2)] hover:bg-neutral-700' 
        ...
        <div className="space-y-4 pt-4 border-t border-neutral-800">
          ...
          <div className="p-3 rounded-lg bg-neutral-900 border border-neutral-800 flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <span className="font-semibold text-xs text-white">الصالة نشطة</span>
            </div>
            <span className="font-bold text-xs text-amber-500">مشرف م4</span>
          </div>
        </div>
      </aside>

      {/* Main Canvas Area */}
      <div className="lg:pr-72 flex flex-col flex-1 min-w-0">
          ...
          <div className="flex items-center justify-between px-6 py-3 max-w-7xl mx-auto w-full gap-4">
            ...
            <div className="flex items-center gap-6 flex-1 max-w-xl">
              ...
              <div className="relative w-full hidden sm:block">
                ...
                <input 
                  type="search" 
                  placeholder="ابحث عن الرياضيين بالاسم..." 
                  className="w-full pr-10 pl-4 py-2 rounded-lg bg-neutral-900 border border-neutral-800 text-white placeholder-neutral-500 text-sm focus:border-amber-500 focus:ring-1 focus:ring-amber-500 focus:outline-none transition-all"
                />
              </div>
            </div>
            ...
            <div className="flex items-center gap-3">
              <button aria-label="Notifications" className="relative p-2 rounded-lg text-neutral-400 hover:text-amber-500 hover:bg-neutral-900 active:scale-[0.98] transition-colors duration-150">
                ...
                <span className="absolute top-1.5 left-1.5 w-2 h-2 bg-amber-500 rounded-full ring-2 ring-neutral-950"></span>
              </button>
              ...
              <div className="relative">
                ...
                <span className="absolute -bottom-0.5 -left-0.5 w-2.5 h-2.5 bg-amber-500 rounded-full ring-2 ring-neutral-950"></span>
              </div>
            </div>
          </div>
        </header>
